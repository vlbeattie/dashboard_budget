...
export function getDataDateBounds(transactions) {
 ...
 */
export function getPresetRange(preset, transactions) {
 ...
 */
export function groupSmallCategories(aggregated, threshold = OTHER_THRESHOLD) {
